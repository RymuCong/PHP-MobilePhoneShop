...
include_once "table/table.product.php";
 ...
 */
function paginate($_total=0, $_page=1, $_limit=20, $_url='', $_num_links=20)
{
	...
	$num_links = 20;	// số lượng đường link trong các đường link phân trang (number of active links in the paging links
	$url = '';
	 ...
	 */
	{
		...
		$web_pagination_results = sprintf("<br>Hiển thị từ %s đến %s của %s (%s Trang)",
									$pageStart,
									$pageEnd,
									$total,
									$totalPages);
...
function price_text_vnd_sale($price_sale){
