...
if (isset($_REQUEST['filter_price_sale'])) 
{
     $url .= '&filter_price_sale=' . $_REQUEST['filter_price_sale'];
}
...
{
     $product_price_sale = $_POST['price_sale'];
} 
elseif (!empty($product_info)) 
{
     $product_price_sale = $product_info['price_sale'];
} 
else 
{
     $product_price_sale = '';
