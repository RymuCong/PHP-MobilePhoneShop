...
$filter_price_sale    = isset($_GET['filter_price_sale'])    ? $_GET['filter_price_sale']    : null; // Tìm theo giá sản phẩm
...
$filter_data = array(
	...
	'filter_price_sale'	  => $filter_price_sale,
...
foreach ($results as $result) 
{
	...
	$products[] = array(
		...
		'price_sale'      => $price_sale = number_format($result['price_sale'],0,'.',',').' đ',
...
if (isset($_GET['filter_price_sale'])) 
{
     $url .= '&filter_price_sale=' . $_GET['filter_price_sale'];
}
