                            ...
                            <div class="product-grid">
                                <ul class="row">
                                    ...
                                    <?php foreach ($productsByCategory as $product) { ?>
                                        <li class="span3 <?php if ($i % 3 == 0) echo 'first-in-line';
                                                            elseif ($i % 3 == 2) echo 'last-in-line'; ?>>">
                                            <div class="image">
                                            ...
                                            <?php } ?>
                                                ...
                                                <div class="cart-button">
                                                    <div class="cart">
                                                        <!-- <a onclick="cart.add('<?php echo $product['product_id'] ?>');" class="button" title="Thêm vào giỏ"><i class="icon-shopping-cart"></i> <span>Thêm vào giỏ</span></a> -->
                                                        <a onclick="cart.add('<?php echo $product['product_id']; ?>');" title="Add to Cart" data-id="29;" class="button addToCart"><i class="icon-shopping-cart"></i> <span>Thêm Vào Giỏ</span></a>
                                                    </div>
                    ...
                    <div class="box info">
                        ...
                        <div class="box-content">
                            <ul class="info-list">
                                ...
                                <li><a href="/delivery.php">Giao Nhận Hàng</a></li>
                                <li><a href="/privacy.php">Chính Sách Bảo Mật</a></li>
                                <li><a href="/regulation.php">Điều Khoản</a></li>
                                <li class="last"><a href="/contact.php">Liên Hệ</a></li>
                            </ul>
                        </div>
                    </div>
