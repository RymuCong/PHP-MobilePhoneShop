            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right" style = "text-align: center;">Hành động</td>
                </tr>
              </thead>
              <tbody>
                <?php if ($orders) { ?>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <a href="<?php echo $order['check']; ?>" data-toggle="tooltip" title="Hoàn Thành" class="btn" style = "background-color: #39c539;"><i class="fa fa-check" style= "color: white;"></i></a>
                  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
