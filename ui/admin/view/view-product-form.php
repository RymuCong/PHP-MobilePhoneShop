          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
                ...
                <div class="tab-pane" id="language">
	              ...
	              <div class="form-group">
	                <label class="col-sm-2 control-label" for="input-price-sale">Giá Khuyến Mãi</label>
	                <div class="col-sm-10">
	                  <input type="text" name="price_sale" value="<?php echo $product_price_sale; ?>" placeholder="Giá Khuyến Mãi" id="input-price-sale" class="form-control" />
	                </div>
	              </div>
              <div class="form-group">
