...
<!--                     <i class="fa icon-social-buffer"></i> -->
				   <img src="<?php echo web_logo_url();?>" width="70%"/>
            ...
            <nav class="navigation">
                <ul class="list-unstyled">
                    ...
                    <li class="has-submenu"><a href="#"><i class="fa fa-cogs fa-fw"></i> <span class="nav-label">Hệ Thống</span><i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="list-unstyled">
                        <li><a href="/admin/dashboard.php"><i class="fa fa-bar-chart fa-fw"></i><span>Dashboard</span></a>
						      </li>
                            <li><a href="/admin/setting-edit.php"><i class="fa fa-cog fa-fw"></i><span>Cài Đặt</span></a></li>
                ...
                <ul class="list-inline navbar-right top-menu top-right-menu">  
                    ...
                    <li class="dropdown text-center">
                        ...
                        <ul class="dropdown-menu extended pro-menu fadeInUp animated" tabindex="5003" style="overflow: hidden; outline: none;">
                            <li><a href="/admin/user-edit.php?user_id=<?php echo user_id();?>"><i class="fa fa-briefcase"></i>Trang Cá Nhân</a></li>
                            <li><a href="/admin/setting-edit.php"><i class="fa fa-cog"></i> Cài Đặt</a></li>
